...
// (per /app/design_guidelines.json). Sections: Hero · Trust band · Modules
// bento · Workflow walkthrough · FAQ · Final CTA.
...
import {
  ...
  Network, Beaker, FlaskConical, Atom, Dna, Target, Microscope,
...
const FAQS = [
  ...
  { q: "How is this different from ChatGPT or generic AI chatbots?",
    a: "PhytoNet AI runs real network-pharmacology tools (AutoDock Vina, SEA-style prediction, SwissADME, KEGG/DisGeNET) — not a language model hallucinating results. Every step has an audit trail and cited data sources." },
