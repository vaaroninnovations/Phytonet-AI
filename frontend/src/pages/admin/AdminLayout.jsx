...
import {
  ...
  UserCog, LogOut, Loader2, MessageSquare, Mail, Building2, BarChart3, Tag,
} from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/metrics", label: "Usage Metrics", icon: BarChart3, testid: "admin-nav-metrics" },
  { to: "/admin/sales", label: "Sales Inquiries", icon: Building2, testid: "admin-nav-sales" },
  { to: "/admin/promos", label: "Promo Codes", icon: Tag, testid: "admin-nav-promos" },
